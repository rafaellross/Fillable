...
$pdf->SetFont('Arial','',8);
$pdf->Cell($width_days,5, $data->monStart . (is_null($data->monEnd) ? " - " : "") . $data->monEnd,'LRB',0,'C');
$pdf->Cell($width_days,5, $data->tueStart . (is_null($data->tueEnd) ? " - " : "") . $data->tueEnd,'RB',0,'C');
$pdf->Cell($width_days,5, $data->wedStart . (is_null($data->wedEnd) ? " - " : "") . $data->wedEnd,'RB',0,'C');
$pdf->Cell($width_days,5, $data->thuStart . (is_null($data->thuEnd) ? " - " : "") . $data->thuEnd,'RB',0,'C');
$pdf->Cell($width_days,5, $data->friStart . (is_null($data->friEnd) ? " - " : "") . $data->friEnd,'RB',0,'C');
$pdf->Cell($width_days,5, $data->satStart . (is_null($data->satEnd) ? " - " : "") . $data->satEnd,'RB',0,'C');
$pdf->Cell(10,5,'',0,0,'C');
